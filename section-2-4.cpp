 ...
 public:
  ...
  array<double, NUMBER_OF_ACTIONS> train(int iterations) {
    ...
    for (int i = 0; i < iterations; i++) {
      ...
      action_utility[(int)opponents_action == NUMBER_OF_ACTIONS - 1
                         ? 0
                         : (int)opponents_action + 1] = 1;
      action_utility[(int)opponents_action == 0 ? NUMBER_OF_ACTIONS - 1
                                                : (int)opponents_action - 1] =
          -1;
